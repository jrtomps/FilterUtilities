...
*/
class CDuplicateFilter : public CFilter
{
  private:
  ...
  public:
    CDuplicateFilter();
    CDuplicateFilter(const CDuplicateFilter& rhs);
    ~CDuplicateFilter();

    virtual CDuplicateFilter* clone() const { return new CDuplicateFilter(*this);}
    ...
    CRingItem* filterDuplicate(CRingItem* item);
